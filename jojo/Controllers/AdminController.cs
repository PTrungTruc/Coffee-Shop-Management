...
namespace jojo.Controllers
{
    public class AdminController : Controller
    {
        ...
        public ActionResult Login()
        {
            try
            {
                var taikhoan = Request.Form["taikhoan"]; //Convert.ToInt32(Request.Form["id"]);
                var matkhau = Request.Form["matkhau"];
                admin a = (from b in db.admins
                           where b.taikhoan == taikhoan && b.matkhau == matkhau
                ...
                {
                    ViewBag.ErrorMessageAdmin = "Invalid username or password.";
                }
            }
            catch
            {
        ...
        public ActionResult Phuchoihoadon(string id)
        {
            ...
            try
            {
                ...
                var query2 = from b in db.hoadons
                             where b.id == a.idhoadon && b.active == "false"
                             select b;
